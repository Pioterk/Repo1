...
const routes: Routes = [
  { path: 'login', component: LoginComponent },
  {
    path: '', component: MaincontainerComponent, children: [
      ...
      { path: 'user', loadChildren: () => import('./svc-user/svc-users.module').then(m => m.SvcUsersModule),canActivate: [AuthGuard]  },
      ...
      { path: 'strategy', loadChildren: () => import('./strategy/strategy.module').then(m => m.StrategyModule),canActivate: [AuthGuard]},
      { path: 'datapoint', loadChildren: () => import('./datapoint/datapoint.module').then(m => m.DatapointModule),canActivate: [AuthGuard]},
    ]},
